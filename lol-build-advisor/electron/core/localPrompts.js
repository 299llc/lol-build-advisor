...
- 「取得可能」と書かれているオブジェクトだけを指示対象にしてよい
- 「未出現」「対象外」「リスポーン待ち」と書かれているオブジェクトは、まだマップに存在しません。移動・準備・確保を指示してはいけません
- オブジェクト名（ドラゴン、バロン、ヘラルド、ヴォイドグラブ）が「対象外」なら、そのオブジェクトに言及しないでください

■ 判断の手順:
1. 【オブジェクト状況】を確認し、「取得可能」のオブジェクトがあるか確認する
